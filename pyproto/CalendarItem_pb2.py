...
# source: pyproto/CalendarItem.proto
...
CalendarItem = _reflection.GeneratedProtocolMessageType('CalendarItem', (_message.Message,), {
  ...
  '__module__' : 'pyproto.CalendarItem_pb2'
